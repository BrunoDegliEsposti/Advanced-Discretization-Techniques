...
function [A,wM] = AssembleMatrices(coord,elemNodeTable,coeff_a,coeff_r)
    ...
    wM  = sparse(n_vertices, n_vertices); %weighted mass matrix
    ...
    for element_index = 1:n_elem
        ...
        for i = 1:3
            for j = 1:3
                ...
                wM(vi_idx, vj_idx) = wM(vi_idx, vj_idx) + integralM;
            end
        end
    end
end
